/* Copyright 2024 Grug Huhler.  License SPDX BSD-2-Clause.
   ...
   2. ../src/inc/mem_initX.ini, where X = 0, 1, 2, 3.
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < 4; i++) {
    ...
    sprintf(fname, "../src/inc/mem_init%d.ini", i);
  ...
  fp_param = fopen("../src/inc/sys_parameters.v", "w");
  if (fp_param == NULL) {
    fprintf(stderr, "could not open file %s\n", "../src/inc/sys_parameters.v");
    exit(EXIT_FAILURE);
  }
